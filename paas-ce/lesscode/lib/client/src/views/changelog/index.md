...
* **[add]**:
    - 项目: 新增项目模板，用户可在模板市场或新建项目时，基于官方模板直接创建项目
    - 项目：新增页面内容模板，用户可以在画布中将页面的局部或者整个内容区域保存为模板，并在新建页面时或者画布拖拽中直接使用
...
* **[fix]**:
    - 项目: 修复项目、页面、函数分类、自定义组件分类名称校验重名时不区分大小写问题

        ...
        <section slot="content" class="item-container">
            ...
            <bk-form
                ...
                <bk-form-item label="字段名称" required property="property" error-display-type="normal">
                    <bk-input v-model="formItemData.property" placeholder="以英文字符、下划线开头；只允许英文字符、数字、下划线、和 -" />
                </bk-form-item>
                <bk-form-item label="Label" required property="label" error-display-type="normal">
                    <bk-input v-model="formItemData.label" />
                </bk-form-item>
                <bk-form-item label="表单项类型" error-display-type="normal">

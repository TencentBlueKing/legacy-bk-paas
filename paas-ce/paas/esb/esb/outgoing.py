...
class BasicHttpClient(object):
    ...
    def _request(self, method, host, path, params=None, data=None, headers={},
        ...
        try:
            ...
            resp = client.request(
                method, url, params=params_to_send, data=data_to_send,
...
class HttpClient(BasicHttpClient):
    ...
    def request(self, method, host, path, params=None, data=None, headers={}, response_type='json',
        ...
        r = self._request(
            method, host, path, params, data, req_headers, response_type, max_retries,

...
class BaseRateLimiter(object):
    ...
    def acquire(self, tokens=1):
        ...
        logger.debug(
            "Start acquiring tokens by given rules, this operation may have several " "communications with redis."
        )
        rets = []
...
class RateLimiter(BaseRateLimiter):
    ...
    def acquire_by_single_rule(self, rule, tokens=1):
        ...
        return {"allowed": not over_limit, "remaining_tokens": max(remaining_tokens, 0)}

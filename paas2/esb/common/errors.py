...
class RequestSSLException(BaseException):
    ...
    def get_message(self):
        ...
        return (
            u"Component request third-party system [%s] interface [%s] SSL error: "
...
class ErrorCodes(object):
    ...
    error_codes = (
        ...
        ErrorCode(
            "TEST_HOST_NOT_FOUND", 1306206, "Error, the component does not support access third-party test environment"
        ),  # noqa

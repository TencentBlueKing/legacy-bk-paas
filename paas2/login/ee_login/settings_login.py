...
# 配置企业微信登录请求和登录回调的响应函数, 如：CUSTOM_LOGIN_VIEW = 'ee_official_login.qrcode.wecom.views.login'
CUSTOM_LOGIN_VIEW = ""

# 配置自定义验证是否登录的认证函数, 如：CUSTOM_AUTHENTICATION_BACKEND = 'ee_official_login.oauth.google.backends.OauthBackend'
# 配置企业微信验证是否登录的认证函数, 如：CUSTOM_AUTHENTICATION_BACKEND = 'ee_official_login.qrcode.wecom.backends.QrcodeBackend'
